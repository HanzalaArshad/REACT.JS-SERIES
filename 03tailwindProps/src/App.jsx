...
function App() {
  ...
  return (
    ...
    <h1 className='bg-green-400 text-black p-4 rounded-xl mb-4'>Tailwind test</h1>
     <Card username="chaiaurcode" someObj={newAr}  btnText="clickme " />
     <Card  username= "mac"  btnText="click me"/>
  ...
  <img class="w-24 h-24 rounded-full mx-auto" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKjn1ud9N_wCe7YDh1Mb46fcEIozkOYUeCN_KYdbXezA&s' alt="" width="384" height="512"/>
